...
test_registration.py    - тестирование регистрации нового пользователя.
    test_successful_registration() - тестирование успешной регистрации пользователя.
    test_unsuccessful_registration() - тестирование ошибки регистрации при неправильном пароле.
test_login.py           - тестирование входа зарегистрированного пользователя.
    test_login_main_form() - вход по кнопке "Войти в аккаует" на главной форме.  
