...
class Test_login():
    ...
    def test_login_main_form(self, driver, registration):
        ...
        WebDriverWait(driver, 10).until(EC.element_to_be_clickable(Locators.EMAIL_EDIT_LOGIN))
    ...
    def test_login_via_the_button_in_the_registration_form(self, driver, registration):
        ...
        WebDriverWait(driver, 20).until(EC.element_to_be_clickable(Locators.PLACE_AN_ORDER))
        assert "Оформить заказ"== element.text
    ...
    def test_login_through_the_button_in_the_password_recovery_form(self, driver, registration):
        ...
        # Ожидаем форму входа.
         ...
         WebDriverWait(driver, 10).until(EC.element_to_be_clickable(Locators.BUTTON_IN_AFTER_REG))
        # Войти в аккаунт.
        driver.find_element(*Locators.BUTTON_IN_AFTER_REG).click()
        # Восстановить пароль.
